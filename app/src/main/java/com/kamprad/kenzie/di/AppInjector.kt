...
object AppInjector {
    ...
    /** Setup injection. */
    fun init(kampradApp: KampradApp) {
        DaggerAppComponent.builder().application(kampradApp)
            .build().inject(kampradApp)
        kampradApp.registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks {
